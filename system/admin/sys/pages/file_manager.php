...
<div id="storage" style="box-shadow: 1px 1px 29px -5px rgba(0,0,0,0.66);max-width:90%;width:650px;border:2px solid<?php echo($theme['bodyBackground']) ?>; padding:10px;margin-top:10px;">
<h3 style="padding:0;margin:0;"><img style="display:inline;height:32px;width:32px;margin-bottom:-8px;margin-right:5px;" src="./system/main/theme/icon/storage.svg"/>Storage</h3>
<?php
