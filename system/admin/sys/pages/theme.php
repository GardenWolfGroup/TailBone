...
?>
<script src="./system/jScripts/jscolor.min.2.0.4.js"></script>
<style>
	.fancy_input{
...
<form action="./?admin&request&action=editTheme" method="post">
	<h2>--Background--</h2>
	Site Background: <input class="fancy_input jscolor" type="text" name="bodyBackground" value="<?PHP echo($bodyBackground); ?>"><br>
	...
	Text Colour: <input class="fancy_input jscolor" type="text" name="contentText" value="<?PHP echo($contentText); ?>"><br>
	<h2>--Colours--</h2>
	<p>(In order of appearance.)<br>Click boxes for colour picker!</p>
	Nav Background: <input class="fancy_input jscolor" type="text" name="navBackground" value="<?PHP echo($navBackground); ?>"><br>
	Nav Text Colour: <input class="fancy_input jscolor" type="text" name="navText" value="<?PHP echo($navText); ?>"><br>
	Nav highlight colour: <input class="fancy_input jscolor" type="text" name="navHighlightColour" value="<?PHP echo($navHighlightColour); ?>"><br>
	Topper Background: <input class="fancy_input jscolor" type="text" name="topperBackground" value="<?PHP echo($topperBackground); ?>"><br>
	Topper Text Colour: <input class="fancy_input jscolor" type="text" name="topperText" value="<?PHP echo($topperText); ?>"><br>
	Content Background: <input class="fancy_input jscolor" type="text" name="contentBackground" value="<?PHP echo($contentBackground); ?>"><br>
	Footer Background: <input class="fancy_input jscolor" type="text" name="enderBackground" value="<?PHP echo($enderBackground); ?>"><br>
	<h2>--Custom--<h2></h2>
