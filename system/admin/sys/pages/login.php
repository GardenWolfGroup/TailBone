...
<center>
	...
	<form action="./?admin&request&action=loginSubmit" method="post">
		...
		<br>
		<input class="fancy_input" type="submit" value="" style="width:62px;background-image:url('./system/main/theme/icon/key.svg');background-position:center;background-repeat:no-repeat;">
	</form>
	<br>
